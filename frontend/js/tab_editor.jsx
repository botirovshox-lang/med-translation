        ...
        React.createElement("div", { className: "table-head" },
          ...
          !inZone && order === "doc" && outOfOrder > 0 && React.createElement("div", { className: "zone-strip" },
            ...
            React.createElement("span", null,
              ...
              + TR(" строк(и). Сегменты, распознанные на картинках, и строки, разрезанные вручную, заводятся позже остальных и номер получают по счёту заведения, а в таблице стоят на своём месте в документе.")),

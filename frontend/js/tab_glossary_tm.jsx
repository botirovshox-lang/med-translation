...
const CAND_KIND = {
  ...
  // Совет ревизии, который держит подпись человека на сегменте: перевод
  // предложила модель, в тексте его НЕТ. Приказом такая карточка не станет
  // никогда — только решением человека (см. _auto_verdict).
  review:   [TR("Совет ревизии"), "eye", "var(--c-purple)"],
};

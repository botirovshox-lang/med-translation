...
const askTitles = {
  ...
  confirmedFindings: "Это ваши строки, а я нашла в них ошибку",
...
check(at("с галочкой «чинить мои строки»") !== -1,
      "написанное и заверенное человеком с находками ведёт к двери, которую он видит, а не к строке «Ремонт»");

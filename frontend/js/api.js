...
(function () {
  ...
  window.API = {
    ...
    backcheckBatch:(pid, segIds, limit, model, judge, judgeModel) => call("POST", `/projects/${pid}/backcheck/batch`, { segment_ids: segIds || null, limit: limit || 10, model: model || null, use_judge: !!judge, judge_model: judgeModel || null }),
